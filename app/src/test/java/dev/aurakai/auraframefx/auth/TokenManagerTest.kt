...
class TokenManagerTest {
    ...
    fun updateTokens_persistsValues_andComputesExpiryInMillis() {
        ...
        assertTrue(expiry in (before + ttlSeconds * 1000)..(after + ttlSeconds * 1000), "Expiry must be now + ttlSeconds")
    ...
    fun updateTokens_handlesZeroTtl_asExpiredImmediately() {
        ...
        assertTrue(tm.isTokenExpired, "Zero TTL implies expiryTime == now, which is treated as expired")
    ...
    private class FakeSharedPreferences : SharedPreferences {
        ...
        private inner class EditorImpl : SharedPreferences.Editor {
            ...
            override fun putString(key: String?, value: String?): SharedPreferences.Editor = applyAlso {
                if (key != null) pending[key] = value
            }

            override fun putStringSet(key: String?, values: MutableSet<String>?): SharedPreferences.Editor = applyAlso {
            ...
            override fun putFloat(key: String?, value: Float): SharedPreferences.Editor = applyAlso {
                if (key != null) pending[key] = value
            }

            override fun putBoolean(key: String?, value: Boolean): SharedPreferences.Editor = applyAlso {
                if (key != null) pending[key] = value
            }
